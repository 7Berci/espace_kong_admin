...
class AjouterExpress extends StatefulWidget {
  const AjouterExpress({super.key});

  @override
  AjouterExpressView createState() => AjouterExpressView();
}

class AjouterExpressView extends State<AjouterExpress> {
          ...
          children: <Widget>[
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (builder) => const ClothesExpress()));
              },
              child: Row(children: [
                Padding(
                ...
                IconButton(
                  onPressed: () {
                    ...
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (builder) => const ClothesExpress()));
                  },
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (builder) => const SpecialExpress()));
              },
              child: Row(children: [
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 8, 8, 8),
                ...
                IconButton(
                    ...
                    onPressed: () {
                     initAllSpecialExpress;
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (builder) => const SpecialExpress()));
                    })
              ]),
            ),
            const Divider(),
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (builder) => const AccessoriesExpress()));
              },
              child: Row(children: [
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 8, 8, 8),
            ...
            GestureDetector(
              onTap: () {
                initAllBathExpress;
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (builder) => const BainExpress()));
              },
              child: Row(children: [
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 8, 8, 8),
                ...
                IconButton(
                    ...
                    onPressed: () {
                      initAllBathExpress;
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (builder) => const BainExpress()));
                    })
              ]),
            ),
            const Divider(),
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (builder) => const LiterieExpress()));
              },
              child: Row(children: [
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 8, 8, 8),
                ...
                IconButton(
                    ...
                    onPressed: () {
                      initAllBeddingExpress;
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (builder) => const LiterieExpress()));
                    })
              ]),
            ),
            const Divider(),
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (builder) => const AutreExpress()));
              },
              child: Row(children: [
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 8, 8, 8),
                ...
                IconButton(
                    ...
                    onPressed: () {
                      initAllOthersExpress;
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (builder) => const AutreExpress()));
                    })
              ]),
            ),
            const Divider(),
