...
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_accessoires_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_autres_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_bain_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_literie_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_special_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_vetements_screen_express.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../cart_folder/cart_controller.dart';
import '../catalog_product/products_model_list.dart';

class AjouterExpressRepassage extends StatefulWidget {
  final String id;
  final String email;
  final ville;
  final quartier;

  const AjouterExpressRepassage({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
...
class AjouterExpressView extends State<AjouterExpressRepassage> {
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => AccessoriesExpressIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
