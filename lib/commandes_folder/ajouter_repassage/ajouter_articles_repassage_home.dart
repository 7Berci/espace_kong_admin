import 'package:espace_kong_admin/commandes_folder/ajouter_repassage/ajouter_repassage_express_screen.dart';
import 'package:espace_kong_admin/commandes_folder/ajouter_repassage/ajouter_repassage_normal_screen.dart';
import 'package:espace_kong_admin/commandes_folder/ajouter_repassage/ajouter_repassage_superexpress_screen.dart';
import 'package:espace_kong_admin/home_folder/home.dart';
import 'package:flutter/material.dart';

class ArticlesToIron extends StatefulWidget {
  final String id;
  final String email;
  final ville;
  final quartier;

  const ArticlesToIron({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
...
class ArticlesView extends State<ArticlesToIron> {
  ...
  void initState() {
    super.initState();
    screens = [
      AjouterNormalRepassage(
        id: widget.id,
        email: widget.email,
        ville: widget.ville,
        quartier: widget.quartier,
      ),
      AjouterExpressRepassage(
        id: widget.id,
        email: widget.email,
        ville: widget.ville,
        quartier: widget.quartier,
      ),
      AjouterSuperExpressRepassage(
        id: widget.id,
        email: widget.email,
        ville: widget.ville,
        quartier: widget.quartier,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(
          ...
          child: Text('Ajouter des articles repassage'),
        ),
      ),
