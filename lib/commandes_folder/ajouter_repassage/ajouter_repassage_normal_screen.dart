...
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_accessoires_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_autres_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_bain_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_literie_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_special_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_iron/catalog_vetements_screen.dart';
...
class AjouterNormalRepassage extends StatefulWidget {
  final String id;
  final String email;
  final ville;
  final quartier;

  const AjouterNormalRepassage({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
  ...
  @override
  AjouterNormalRepassageView createState() => AjouterNormalRepassageView();
}

class AjouterNormalRepassageView extends State<AjouterNormalRepassage> {
