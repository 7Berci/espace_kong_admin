...
class CatalogBeddingProductsExpressWashandIron extends StatelessWidget {
  const CatalogBeddingProductsExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogBeddingProductsCardExpress(
...
class CatalogBeddingProductsCardExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogBeddingProductsCardExpress({required this.product, super.key});
