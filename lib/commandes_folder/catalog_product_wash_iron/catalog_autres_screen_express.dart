...
// return AlertDialog(
class AutreExpressWashandIron extends StatelessWidget {
  final String email;
  final String id;
  final ville;
  final quartier;
  const AutreExpressWashandIron({super.key, required this.id, required this.email
   , required this.ville,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            CatalogOthersProductsExpressWashandIron(),
