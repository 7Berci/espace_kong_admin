...
class CatalogAccessoriesProductsWashandIron extends StatelessWidget {
  const CatalogAccessoriesProductsWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogAccessoriesProductsCard(
...
class CatalogAccessoriesProductsCard extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogAccessoriesProductsCard({required this.product, super.key});
