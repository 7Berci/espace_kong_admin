...
class CatalogVetementsProductsWashandIron extends StatelessWidget {
  const CatalogVetementsProductsWashandIron({super.key});
...
class CatalogProductsCard extends StatelessWidget {
  ...
  CatalogProductsCard({required this.product, super.key});
