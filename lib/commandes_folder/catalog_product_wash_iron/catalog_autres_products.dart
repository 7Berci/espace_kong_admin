...
class CatalogOthersProductsWashandIron extends StatelessWidget {
  const CatalogOthersProductsWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogOthersProductsCard(
...
class CatalogOthersProductsCard extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogOthersProductsCard({required this.product, super.key});
