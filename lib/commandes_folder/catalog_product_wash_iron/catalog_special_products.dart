...
class CatalogSpecialProductsWashandIron extends StatelessWidget {
  const CatalogSpecialProductsWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogSpecialProductsCard(
...
class CatalogSpecialProductsCard extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogSpecialProductsCard({required this.product, super.key});
