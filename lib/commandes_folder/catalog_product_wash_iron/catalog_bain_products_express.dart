...
class CatalogBathProductsExpressWashandIron extends StatelessWidget {
  const CatalogBathProductsExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogBathProductsCardExpress(
...
class CatalogBathProductsCardExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogBathProductsCardExpress({required this.product, super.key});
