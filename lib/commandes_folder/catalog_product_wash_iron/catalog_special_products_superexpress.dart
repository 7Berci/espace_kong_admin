...
class CatalogSpecialProductsSuperExpressWashandIron extends StatelessWidget {
  const CatalogSpecialProductsSuperExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogSpecialProductsCardSuperExpress(
...
class CatalogSpecialProductsCardSuperExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogSpecialProductsCardSuperExpress({required this.product, super.key});
