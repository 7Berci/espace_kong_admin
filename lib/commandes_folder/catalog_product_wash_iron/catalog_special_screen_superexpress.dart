...
class SpecialSuperExpressWashandIron extends StatelessWidget {
  final String email;
  final String id;
  final ville;
  final quartier;
  const SpecialSuperExpressWashandIron({super.key,
    required this.ville,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            CatalogSpecialProductsSuperExpressWashandIron(),
