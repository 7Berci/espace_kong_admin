...
class ClothesSuperExpressWashandIron extends StatelessWidget {
  final String id;
  final String email;
  final ville;
  final quartier;
  const ClothesSuperExpressWashandIron({super.key, 
    required this.ville,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            CatalogVetementsProductsSuperExpressWashandIron(),
