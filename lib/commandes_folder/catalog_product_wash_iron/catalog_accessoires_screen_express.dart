...
class AccessoriesExpressWashandIron extends StatelessWidget {
  final String email;
  final String id;
  final ville;
  final quartier;
  const AccessoriesExpressWashandIron({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Accessoires Express')),
        backgroundColor: const Color(0xFF5ACC80),
      ),
      body: SafeArea(
        child: Column(
          children: [
            CatalogAccessoriesProductsExpressWashandIron(),
