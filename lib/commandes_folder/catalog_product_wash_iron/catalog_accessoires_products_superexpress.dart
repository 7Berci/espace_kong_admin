...
class CatalogAccessoriesProductsSuperExpressWashandIron extends StatelessWidget {
  const CatalogAccessoriesProductsSuperExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogAccessoriesProductsCardSuperExpress(
...
class CatalogAccessoriesProductsCardSuperExpress extends StatelessWidget {
  int counter = 0;
