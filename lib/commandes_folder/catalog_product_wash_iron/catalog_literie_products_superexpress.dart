...
class CatalogBeddingProductsSuperExpressWashandIron extends StatelessWidget {
  const CatalogBeddingProductsSuperExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogBeddingProductsCardSuperExpress(
...
class CatalogBeddingProductsCardSuperExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogBeddingProductsCardSuperExpress({required this.product, super.key});
