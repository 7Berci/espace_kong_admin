...
class CatalogOthersProductsExpressWashandIron extends StatelessWidget {
  const CatalogOthersProductsExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogOthersProductsCardExpress(
...
class CatalogOthersProductsCardExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogOthersProductsCardExpress({required this.product, super.key});
