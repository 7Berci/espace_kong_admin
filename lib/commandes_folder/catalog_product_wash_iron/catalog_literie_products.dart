...
class CatalogBeddingProductsWashandIron extends StatelessWidget {
  const CatalogBeddingProductsWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogBeddingProductsCard(
...
class CatalogBeddingProductsCard extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogBeddingProductsCard({required this.product, super.key});
