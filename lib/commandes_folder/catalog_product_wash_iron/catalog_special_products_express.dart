...
class CatalogSpecialProductsExpressWashandIron extends StatelessWidget {
  const CatalogSpecialProductsExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogSpecialProductsCardExpress(
...
class CatalogSpecialProductsCardExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogSpecialProductsCardExpress({required this.product, super.key});
