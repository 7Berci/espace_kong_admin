...
class CatalogBathProductsSuperExpressWashandIron extends StatelessWidget {
  const CatalogBathProductsSuperExpressWashandIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogBathProductsCardSuperExpress(
...
class CatalogBathProductsCardSuperExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogBathProductsCardSuperExpress({required this.product, super.key});
