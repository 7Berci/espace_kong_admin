...
class ClothesExpressWashandIron extends StatelessWidget {
  final String email;
  final String id;
  final ville;
  final quartier;
  const ClothesExpressWashandIron({super.key,
    required this.ville,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Vêtements Express')),
        backgroundColor: const Color(0xFF5ACC80),
      ),
      body: SafeArea(
        child: Column(
          children: [
            CatalogVetementsProductsExpressWashandIron(),
