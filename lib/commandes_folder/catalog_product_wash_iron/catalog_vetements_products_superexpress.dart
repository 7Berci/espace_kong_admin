...
class CatalogVetementsProductsSuperExpressWashandIron extends StatelessWidget {
  const CatalogVetementsProductsSuperExpressWashandIron({super.key});
...
class CatalogProductsCardSuperExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogProductsCardSuperExpress({required this.product, super.key});
