...
class ArticlesToWashnIron extends StatefulWidget {
  final String id;
  final String email;
  final ville;
  final quartier;

  const ArticlesToWashnIron({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
...
class ArticlesView extends State<ArticlesToWashnIron> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(
          ...
          child: Text('Ajouter des articles lavage-repassage'),
        ),
      ),
