...
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_accessoires_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_autres_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_bain_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_literie_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_special_screen.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_vetements_screen.dart';
...
class AjouterNormalLavageRepassage extends StatefulWidget {
  final String id;
  final String email;
  final ville;
  final quartier;

  const AjouterNormalLavageRepassage({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
  ...
  @override
  AjouterNormalLavageRepassageView createState() => AjouterNormalLavageRepassageView();
}

class AjouterNormalLavageRepassageView extends State<AjouterNormalLavageRepassage> {
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => AccessoriesWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
