...
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_accessoires_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_autres_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_bain_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_literie_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_special_screen_express.dart';
import 'package:espace_kong_admin/commandes_folder/catalog_product_wash_iron/catalog_vetements_screen_express.dart';
...
class AjouterExpressLavageRepassage extends StatefulWidget {
  ...
  const AjouterExpressLavageRepassage({
    super.key,
    required this.id,
    required this.email,
    required this.ville,
  ...
  @override
  AjouterExpressViewLavageRepassage createState() => AjouterExpressViewLavageRepassage();
}

class AjouterExpressViewLavageRepassage extends State<AjouterExpressLavageRepassage> {
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => ClothesExpressWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => SpecialExpressWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => AccessoriesExpressWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => BainExpressWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => LiterieExpressWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          builder:
                              (builder) => AutreExpressWashandIron(
                                id: widget.id,
                                email: widget.email,
                                ville: widget.ville,
                                quartier: widget.quartier,
