...
class CatalogOthersProductsSuperExpressIron extends StatelessWidget {
  const CatalogOthersProductsSuperExpressIron({super.key});
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return CatalogOthersProductsCardSuperExpress(
...
class CatalogOthersProductsCardSuperExpress extends StatelessWidget {
  int counter = 0;

  final cartController = Get.put(CartController());
  final Product product;
  CatalogOthersProductsCardSuperExpress({required this.product, super.key});
