...
class CommandeDetailsScreen extends StatelessWidget {
  ...
  const CommandeDetailsScreen({super.key, required this.orderData, required this.orderId});
        ...
        SingleChildScrollView(
          ...
          child: DataTable(
            ...
            rows: List.generate(docs.length, (index) {
              ...
              final articles = data['articles'] != null
                ...
                cells: [
                  ...
                  DataCell(FutureBuilder<double>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text('${snapshot.data!.toStringAsFixed(2)} FCFA');
                    },
                  )),
                  DataCell(TextButton(onPressed: () {
                          Navigator.of(context).push(
                  MaterialPageRoute(builder: (builder) => OrdersListFirst()));
                        }, child: Text(articles)),),
                  ...
                  DataCell(Row(
                    children: [
                      TextButton(
                        ...
                        child: const Text('Ajouter articles/montant'),
                      ),
                      const SizedBox(width: 8),
                      TextButton(
                        onPressed: () {
                          Navigator.pushNamed(context, '/changer_statut', arguments: docs[index].id);
                        },
